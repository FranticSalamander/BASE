<#
    .SYNOPSIS
        Test BASE tool against various outputs for functional testing.
    ...
    .DESCRIPTION
        ...
        provider that is being regression tested based on the product name designation used in BASE.  These include aad,
        ...
        compare against output generated by new runs of BASE by the functional testing tool.  Each file pair must be renamed
    ...
    .EXAMPLE
        ...
        Enter the file path for the BASE working directory. This is where the ProviderExport, TestResults, and Report will be generated by the tool.
...
param (
    ...
    <#
        .PARAMETER Out
            Takes the user's selection of BASE's working directory.
        #>
    [Parameter(Mandatory = $false)]
    [ValidateNotNullOrEmpty()]
    [Alias('o')]
    ...
    <#
        .PARAMETER Quiet
            Runs BASE in silent mode so the reports do not open immediately after generation.
        #>
    [Parameter(Mandatory = $false)]
    [Alias('q')]
    [switch]$Quiet
