Import-Module (Join-Path -Path $PSScriptRoot -ChildPath "../../../../PowerShell/BASE/Modules/Connection/Connection.psm1") -Function 'Connect-Tenant' -Force
Import-Module (Join-Path -Path $PSScriptRoot -ChildPath "../../../../PowerShell/BASE/Modules/Connection/ConnectHelpers.psm1") -Force
