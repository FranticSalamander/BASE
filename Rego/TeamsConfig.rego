...
tests[{
    ...
    "Commandlet" : [],
    "ActualValue" : [],
    "ReportDetails" : "Custom implementation allowed. If you are using Defender to fulfill this requirement, run the Defender version of BASE. Otherwise, use a 3rd party tool OR manually check",
    "RequirementMet" : false
}] {
    true
}
