...
LegacyAuthentication[Cap.DisplayName] {
    ...
    UserExclusionsFullyExempt(Cap, "MS.Entra.1.1v1") == true
    GroupExclusionsFullyExempt(Cap, "MS.Entra.1.1v1") == true
}
...
BlockHighRisk[Cap.DisplayName] {
    ...
    # Only match policies with user and group exclusions if all exempted
    UserExclusionsFullyExempt(Cap, "MS.Entra.2.1v1") == true
    GroupExclusionsFullyExempt(Cap, "MS.Entra.2.1v1") == true
}
...
SignInBlocked[Cap.DisplayName] {
    ...
    # Only match policies with user and group exclusions if all exempted
    UserExclusionsFullyExempt(Cap, "MS.Entra.2.3v1") == true
    GroupExclusionsFullyExempt(Cap, "MS.Entra.2.3v1") == true
}
...
MS_Entra_3_1v1_CAP[Cap.DisplayName] {
    Cap := input.conditional_access_policies[_]
    ...
    GroupExclusionsFullyExempt(Cap, "MS.Entra.3.1v1") == true
    UserExclusionsFullyExempt(Cap, "MS.Entra.3.1v1") == true
...
tests[{
    ...
    "Criticality" : "Shall",
    "Commandlet" : ["Get-MgBetaIdentityConditionalAccessPolicy"],
    "ActualValue" : MS_Entra_3_1v1_CAP,
    "ReportDetails" : concat(". ", [ReportFullDetailsArray(MS_Entra_3_1v1_CAP, DescriptionString), CapLink]),
    "RequirementMet" : Status
}] {
    DescriptionString := "conditional access policy(s) found that meet(s) all requirements"
    Status := count(MS_Entra_3_1v1_CAP) > 0
}
#--
...
AlternativeMFA[Cap.DisplayName] {
    ...
    # Only match policies with user and group exclusions if all exempted
    UserExclusionsFullyExempt(Cap, "MS.Entra.3.2v1") == true
    GroupExclusionsFullyExempt(Cap, "MS.Entra.3.2v1") == true
}

tests[{
    "PolicyId" : "MS.Entra.3.2v1",
    "Criticality" : "Shall",
    "Commandlet" : ["Get-MgBetaIdentityConditionalAccessPolicy"],
...
PhishingResistantMFA[Cap.DisplayName] {
    ...
    Contains(Cap.Conditions.Applications.IncludeApplications, "All")
    IsEmptyContainer(Cap.Conditions.Applications.ExcludeApplications)
    GroupExclusionsFullyExempt(Cap, "MS.Entra.3.6v1") == true
    UserExclusionsFullyExempt(Cap, "MS.Entra.3.6v1") == true
...
RequireManagedDeviceMFA[Cap.DisplayName] {
    ...
    # Only match policies with user and group exclusions if all exempted
    UserExclusionsFullyExempt(Cap, "MS.Entra.3.8v1") == true
    GroupExclusionsFullyExempt(Cap, "MS.Entra.3.8v1") == true
}

tests[{
    "PolicyId": "MS.Entra.3.8v1",
    "Criticality" : "Should",
    "Commandlet" : ["Get-MgBetaIdentityConditionalAccessPolicy"],
...
PrivilegedRolesWithoutExpirationPeriod[Role.DisplayName] {
    ...
    PrivilegedRoleExclusions(Role, "MS.Entra.7.4v1") == true
}
