...
<!--Policy: MS.Entra.2.2v1; Criticality: SHOULD -->
...
<!--Policy: MS.Entra.3.2v1; Criticality: SHALL -->
...
<!--Policy: MS.Entra.3.3v1; Criticality: SHALL -->
...
<!--Policy: MS.Entra.3.4v1; Criticality: SHALL -->
...
<!--Policy: MS.Entra.3.5v1; Criticality: SHALL -->
...
<!--Policy: MS.Entra.3.6v1; Criticality: SHALL -->
...
<!--Policy: MS.Entra.3.7v1; Criticality: SHOULD -->
...
<!--Policy: MS.Entra.3.8v1; Criticality: SHOULD -->
...
<!--Policy: MS.Entra.7.9v1; Criticality: SHOULD -->
...
4. Verify there are no users or groups with a value of **Permanent** in the **End time** column. If there are any, recreate those assignments to have an expiration date using Azure AD PIM or an alternative PAM system. The only exception to this policy is emergency access accounts and service accounts requiring perpetual active assignments. See policy MS.Entra.7.4v1 note section for details.

#### MS.Entra.7.5v1 Instructions
...
#### MS.Entra.7.9v1 Instructions

 1. Follow the same instructions as MS.Entra.7.8v1 for each of the highly privileged roles (other than Global Administrator) but enter a security monitoring mailbox different from the one used to monitor Global Administrator activations.
...
<!--Policy: MS.Entra.8.1v1; Criticality: SHOULD -->
...
<!--Policy: MS.Entra.8.2v1; Criticality: SHOULD -->
...
<!--Policy: MS.Entra.8.3v1; Criticality: SHOULD -->
