...
"@
    ...
    $TenantID | Out-File -FilePath .\configs-json\pp\tenant_id_config.json
    $EnvironmentCreation | Out-File -FilePath .\configs-json\pp\environment_creation_config.json
    $DLPPolicies | Out-File -FilePath .\configs-json\pp\dlp_policies_config.json
